...
import { WizytyComponent } from 'app/entities/wizyty/wizyty.component';
import { WizytyService } from 'app/entities/wizyty/wizyty.service';
import { Wizyty } from 'app/shared/model/wizyty.model';

describe('Component Tests', () => {
  describe('Wizyty Management Component', () => {
    let comp: WizytyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WizytyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.wizyties[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
