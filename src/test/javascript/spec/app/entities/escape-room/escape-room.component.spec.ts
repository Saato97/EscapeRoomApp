...
import { EscapeRoomComponent } from 'app/entities/escape-room/escape-room.component';
...
describe('Component Tests', () => {
  describe('EscapeRoom Management Component', () => {
    let comp: EscapeRoomComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EscapeRoomComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.escapeRooms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
