...
describe('Service Tests', () => {
  describe('Wlasciciel Service', () => {
    let injector: TestBed;
    let service: WlascicielService;
    let httpMock: HttpTestingController;
    let elemDefault: IWlasciciel;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Wlasciciel', async () => {
      ...
      it('should delete a Wlasciciel', async () => {
