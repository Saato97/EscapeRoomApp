...
import { OpinieComponent } from 'app/entities/opinie/opinie.component';
import { OpinieService } from 'app/entities/opinie/opinie.service';
import { Opinie } from 'app/shared/model/opinie.model';

describe('Component Tests', () => {
  describe('Opinie Management Component', () => {
    let comp: OpinieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OpinieComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.opinies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
